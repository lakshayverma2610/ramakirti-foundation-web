    ...
    <html lang="en" className={`${atkinson.variable}`}>
      ...
      <body suppressHydrationWarning={true} className={`${atkinson.variable} font-sans antialiased text-[18px]`}>
        ...
        <a 
          ...
          className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-3 md:p-4 rounded-2xl shadow-lg hover:-translate-y-1 hover:shadow-xl hover:bg-[#1FAF53] transition-all duration-300 flex items-center justify-center cursor-pointer group"
